      ...
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 48 }}>
          ...
          <div>
            ...
            <p style={{ color: "var(--muted)", fontSize: 14, lineHeight: 1.7, maxWidth: 220 }}>
          ...
          <div>
            ...
            {["Cloud Sunucu", "Ağ Yönetimi", "Sunucu Yönetimi", "Siber Güvenlik", "Altyapı Hizmetleri", "IT Danışmanlığı"].map(s => (
              <a key={s} href="#hizmetler" style={{ display: "block", color: "var(--muted)", textDecoration: "none", fontSize: 14, marginBottom: 8 }}
          ...
          <div>
            ...
            {["e-Clinic", "Signed", "ShieldSpot"].map(p => (
              <a key={p} href="#urunler" style={{ display: "block", color: "var(--muted)", textDecoration: "none", fontSize: 14, marginBottom: 8 }}
                onMouseEnter={e => (e.currentTarget.style.color = "var(--blue-light)")}
          ...
          <div>
            ...
            <p style={{ color: "var(--muted)", fontSize: 14, marginBottom: 8 }}>info@xshield.com.tr</p>
            <p style={{ color: "var(--muted)", fontSize: 14, marginBottom: 8 }}>xshield.com.tr</p>

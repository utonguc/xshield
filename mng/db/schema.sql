...
CREATE TABLE IF NOT EXISTS supplier_products (
  id           SERIAL PRIMARY KEY,
  source       VARCHAR(50)   NOT NULL DEFAULT 'erem',
  product_code VARCHAR(100)  NOT NULL,
  title        TEXT          NOT NULL DEFAULT '',
  category     VARCHAR(200),
  price_havale NUMERIC(12,4),
  price_kk     NUMERIC(12,4),
  price_vadeli NUMERIC(12,4),
  currency     VARCHAR(10)   NOT NULL DEFAULT 'USD',
...
CREATE INDEX IF NOT EXISTS idx_supplier_products_cat  ON supplier_products(category);

CREATE TABLE IF NOT EXISTS supplier_credentials (
  id SERIAL PRIMARY KEY,
  source VARCHAR(50) NOT NULL UNIQUE,
  label VARCHAR(100) NOT NULL,
  bayi_kodu VARCHAR(100),
  kullanici_adi VARCHAR(100),
  parola VARCHAR(200),
  enabled BOOLEAN NOT NULL DEFAULT true,
  updated_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
INSERT INTO supplier_credentials (source, label, bayi_kodu, kullanici_adi, parola)
VALUES
  ('erem', 'Erem Online', '', '', ''),
  ('bilsam', 'B2B Depo (Bilsam)', '', '', '')

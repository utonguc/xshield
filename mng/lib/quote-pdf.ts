...
.wm-brand{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-45deg);font-size:80pt;font-weight:900;color:rgba(15,23,42,0.07);white-space:nowrap;pointer-events:none;z-index:0;letter-spacing:0.1em;user-select:none}
.wm-status{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-35deg);font-size:60pt;font-weight:900;white-space:nowrap;pointer-events:none;z-index:1;letter-spacing:0.06em;user-select:none;border-width:8px;border-style:solid;padding:8px 20px;border-radius:8px;opacity:0.22}
